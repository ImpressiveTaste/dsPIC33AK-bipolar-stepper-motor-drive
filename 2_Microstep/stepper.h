...
/* USER DEFINE CONFIGS */
/* MOTOR SPECIFIC */
#define AMPLITUDE_DRIVE                         AMP_TO_U16(1)    /* adjust these values according to your motor and supply voltage */
#define AMPLITUDE_STALL                         AMP_TO_U16(0.05)

#define STEP_SIZE          1.8                  /* Motor degrees / full-step */
#define RELEASE_IN_IDLE    false                 /* True: for power savings, the current through the coils is stopped. */
...
#define AMP_TO_U16(X)                           (uint16_t)(40000.0 * (X) + 0.5)
...
#define Q_DELAY         1 //24                      /* Microseconds */
